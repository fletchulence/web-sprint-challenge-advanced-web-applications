...
export const handlers = [
  rest.post('http://localhost:5004/api/login', login),
  rest.post('http://localhost:5004/api/logout', logout),
  rest.get('http://localhost:5004/api/articles', getAll),
  rest.get('http://localhost:5004/api/articles/:id', getById),
  rest.post('http://localhost:5004/api/articles', create),
  rest.put('http://localhost:5004/api/articles/:id', edit),
  rest.delete('http://localhost:5004/api/articles/:id', remove)
]